...
import {
  PERFORMANCE_WEIGHTS,
  getPerformanceLevel,
  calculatePerilakuKerjaScore as calcPerilakuKerja,
  calculateKualitasKinerjaScore as calcKualitasKinerja,
...
const Report: React.FC<ReportProps> = ({ employees }) => {
  ...
  const selectedOrgLevelHeading = selectedEmployee?.organizational_level
    ? simplifyOrganizationalLevel(
        selectedEmployee.organizational_level,
        selectedEmployee.gol,
      ).toUpperCase()
    : "ESELON";
  ...
  const generatePDF = async () => {
    ...
    try {
      await ReportGenerationService.generatePDF(reportRef.current, {
  ...
  const calculatePerilakuKerjaScore = () => {
    if (
      ...
      return 0;
    const scores = selectedEmployee.performance
      .slice(0, PERFORMANCE_WEIGHTS.PERILAKU_KERJA_COUNT)
      .map((p) => p.score);
    return calcPerilakuKerja(scores);
  };
  ...
  const calculateKualitasKinerjaScore = () => {
    if (
      ...
      return 0;
    const scores = selectedEmployee.performance
      .slice(5, 5 + PERFORMANCE_WEIGHTS.KUALITAS_KINERJA_COUNT)
      .map((p) => p.score);
    return calcKualitasKinerja(scores);
  };

  const getPenilaianPimpinanScore = () => {
    return PERFORMANCE_WEIGHTS.PENILAIAN_PIMPINAN;
  };

  const calculateTotalScore = () => {
    if (!selectedEmployee) return 0;
    return (
      calculatePerilakuKerjaScore() +
      calculateKualitasKinerjaScore() +
      getPenilaianPimpinanScore()
    );
  };
        ...
        <>
          ...
          <div className="mb-8 bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border">
              ...
              <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-sm">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-600">
                    <th className="border border-gray-300 dark:border-gray-500 p-2 text-left text-gray-900 dark:text-white">
                      NO.
                    </th>
                    <th className="border border-gray-300 dark:border-gray-500 p-2 text-left text-gray-900 dark:text-white">
                      KOMPONEN / KRITERIA
                    </th>
                    <th className="border border-gray-300 dark:border-gray-500 p-2 text-center text-gray-900 dark:text-white">
                      BOBOT
                    </th>
                    <th className="border border-gray-300 dark:border-gray-500 p-2 text-center text-gray-900 dark:text-white">
                      NILAI
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-500 p-2 font-semibold text-gray-900 dark:text-white">
                      I.
                    </td>
                    <td className="border border-gray-300 dark:border-gray-500 p-2 font-semibold text-gray-900 dark:text-white">
                      PERILAKU KERJA (30%)
                  ...
                  {selectedEmployee.performance &&
                    ...
                    selectedEmployee.performance
                      ...
                      .map((perf, index) => (
                        <tr key={index}>
                          <td className="border border-gray-300 dark:border-gray-500 p-2 text-gray-700 dark:text-gray-300">
                            {index + 1}
                          </td>
                          <td className="border border-gray-300 dark:border-gray-500 p-2 text-gray-700 dark:text-gray-300">
                            {perf.name}
                          ...
                          <td className="border border-gray-300 dark:border-gray-500 p-2 text-center text-gray-700 dark:text-gray-300">
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 dark:border-gray-500 p-2 text-center font-semibold text-gray-900 dark:text-white">
                      {getPenilaianPimpinanScore().toFixed(2)}
                    </td>
                  </tr>
                  <tr className="bg-yellow-100 dark:bg-yellow-900">
                    <td
                      className="border border-gray-300 dark:border-gray-500 p-2 font-bold text-gray-900 dark:text-white"
                      colSpan={2}
                    >
                      NILAI AKHIR
                    </td>
                    <td className="border border-gray-300 dark:border-gray-500 p-2 text-center font-bold text-gray-900 dark:text-white">
                      85.00
                    </td>
                    <td className="border border-gray-300 dark:border-gray-500 p-2 text-center font-bold text-gray-900 dark:text-white">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
              💡 Tip: Anda dapat memilih dan menyalin data dari tabel di atas
              untuk digunakan di aplikasi lain.
            </p>
          </div>
          ...
          >
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center mb-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs">
                    Jalan Jenderal A. Yani Km 4,5 Komplek Gubernur Kode Pos
                    70234
                  </p>
                  <p className="text-xs">
                  ...
                  <p className="text-xs">
                    Email: dinsos@kalselprov.go.id Website:
                    www.dinsos.kalselprov.go.id
                  </p>
                </div>
              </div>
              ...
              <div className="border-t-2 border-black pt-4">
                <h3 className="font-bold text-sm mb-2">
                  ...
                  <br />
                  KALIMANTAN SELATAN SEMESTER {semester === 1 ? "I" : "II"}{" "}
                  TAHUN {year}
                </h3>
              </div>
            </div>
            ...
            <div className="mb-6">
              <p className="text-xs mb-4 text-justify">
                ...
                Kalimantan Selatan sesuai dengan Semester{" "}
                {semester === 1 ? "I" : "II"} Tahun {year} berdasarkan dari
                Kualitas Kinerja dengan melalui form yang disediakan tiap akhir
                semester, dengan penilaian terdapat sebagai berikut:
              </p>
            </div>
            ...
            <div className="flex gap-8 mb-6">
              ...
              <div className="flex-1">
                <table className="w-full border-collapse border border-black text-xs">
                  <thead>
                    <tr>
                      <th className="border border-black p-2 bg-gray-100 text-center font-bold">
                        NO.
                      </th>
                      <th className="border border-black p-2 bg-gray-100 text-center font-bold">
                        KRITERIA
              ...
              <div className="flex-1">
                <div className="mb-4">
                  <h4 className="font-bold text-xs mb-2 text-center">
                    ...
                    {selectedOrgLevelHeading}
                    <br />
                    DINAS SOSIAL PROVINSI KALIMANTAN SELATAN SEMESTER{" "}
                    {semester === 1 ? "I" : "II"}
                    <br />
                    TAHUN {year}
                  </h4>
            ...
            <div className="mb-6 text-xs">
              <p className="mb-2">
                <strong>
                  Predikat Skor akhir penilaian Penilaian Pegawai dengan kinerja
                  terbaik sebagai berikut:
                </strong>
              </p>
              <div className="ml-4 mb-4">
                <p>
                  a. <strong>SANGAT BAIK</strong> : ≥ 80.00
                </p>
                <p>
                  b. <strong>BAIK</strong> : 70.00 - 79.99
                </p>
                <p>
                  c. <strong>KURANG BAIK</strong> : 65.00 - 69.99
                </p>
              </div>
              <p className="mb-4">
                Kepala Sub Bagian Perencanaan dan Pelaporan{" "}
                <strong>HANDAYATI EKA WARDANI, SE, MM</strong> memperoleh
                predikat{" "}
                <strong>
                  &quot;{getPerformanceLevel(calculateTotalScore())}&quot;
                </strong>{" "}
                dengan nilai <strong>{calculateTotalScore().toFixed(2)}</strong>
                .
              </p>
            </div>
